...
<body>
 <body>
  <a href="index.jsp" ><button style=width:70px;height:50px;margin-left:1000px;color:white;background-color:#006A4E>HOME</button></a> 
        ...
        <form action="frregsuccess.jsp" autocomplete="off"  class="register">
        
        
     <h1>Franchisor Registration Form</h1>
            ...
            <fieldset class="row2">
                ...
                <p>
                    ...
                    <input class="long" name="url" value="" type="text" value="http://"/>
            ...
            <fieldset class="row3">
                ...
                <p>
                    ...
                    <input type="text" name="companyname" value="" class="long"/>
                </p>
              <%--  <p>
                    <label>Photo *
                    </label>
