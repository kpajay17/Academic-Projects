...
try{
	...
	if(user.equalsIgnoreCase("FRANCHISORS"))
	{
		sql="select ordersID,username,ordersdate,status from franchisees a,orders b where a.franchiseesID=b.franchiseesID and b.franchisorsID=? order by status desc";
